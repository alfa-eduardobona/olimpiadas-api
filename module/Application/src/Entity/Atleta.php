...
class Atleta
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\Entity\ImgAtleta", inversedBy="atletas")
     * @ORM\JoinColumn(name="idImgAtleta", referencedColumnName="idImgAtleta")
     */
    protected $idImgAtleta;
