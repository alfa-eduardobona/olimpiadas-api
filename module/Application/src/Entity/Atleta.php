...
class Atleta
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Application\Entity\ImagensAtletas", mappedBy="atletas")
     * @ORM\JoinColumn(name="idImagemAtleta", referencedColumnName="idImagemAtleta")
     */
    private  $idImagemAtleta;
